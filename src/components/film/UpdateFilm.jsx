...
const UpdateFilm = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/films/read/${params.id}`)
      .then((response) => {
  ...
  return (
    <Base>
      ...
      <div className="alert alert-warning" role="alert">
        ...
        <p className="mb-0">
          You might need to have admin role to use this feature!
        </p>
      </div>
      {/* {JSON.stringify(filmDetails)} */}
      <div className="container" style={{ maxWidth: "700px" }}>
        <div className="wrapper mx-5 py-3">
          <Card className="mx-5 py-3 shadow">
            <CardBody>
